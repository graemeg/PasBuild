...
**Dependencies:** Automatically runs `compile` → `test-compile`
...
**Dependencies:** Automatically runs `compile` → `test-compile` → `test`
...
pasbuild test-compile             # Compile tests
pasbuild test                     # Run tests
